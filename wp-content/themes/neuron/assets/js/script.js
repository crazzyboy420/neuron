...
(function ($) {
    ...
    jQuery(document).ready(function ($) {
        $('.comments-area textarea').attr('placeholder','Your Massege');
        $('.comments-area #author').attr('placeholder','Your Name');
        $('.comments-area input[type="email"]').attr('placeholder','Your Email');
        $('.comments-area input[type="url"]').attr('placeholder','Your Website');
