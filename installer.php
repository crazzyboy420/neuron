...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210701_neuron_488293f261273b7e4789_20210706061828_archive.zip';
	const ARCHIVE_SIZE		 = '37319455';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '488293f-06061828';
    const SECONDARY_PACKAGE_HASH = '238edca-06061828';
	const VERSION			 = '1.4.1';
